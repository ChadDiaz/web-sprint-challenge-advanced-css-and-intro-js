...
console.log("The answer to task 1A is " + artists[0].name)
console.log("");
// (2) Bio of the third artist (2nd index) in the array 
console.log("The answer to task 1B is " , [artists[2].bio])
console.log("");

/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue and console.log() to check your work. */
console.log("The answer to task 2 is " , artists[8].name="Vincent Van Gogh")
console.log("");
...
function removeArtist(array, indexNum) {
    ...
    console.log(`The answer to task # 5 is ${array.length}` , array)
    //The task didn't ask us to return the array, but I wanted to put that in there so that I could confirm that "Amedo Modigliani" was removed.
  }
...
function addArtist(dat1, dat2, dat3, dat4, dat5, dat6){
  const additionalArtist = {
    "id": dat1, 
    "name": dat2,
    "years": dat3,
    "genre": dat4,
    ...
    artists.push(additionalArtist)
    console.log("The answer to task 6 is " , artists);
  }
addArtist(20, "Chad", "1972 - 2020", "Web-Design", "Mutt / Mix", "lorem Ipsum as I have nothing to put in here.")
console.log("");
...
function lotsOfArt(numPaintings){
  let numPaitingsArray = [];
  numPaintings.forEach(el => {
    if (el.paintings >= 100){
      numPaitingsArray.push(el);
    }    
  });
  console.log(`The answer to task 7 is ${numPaitingsArray.length} is the number of objects with 100 or more paintings and here is the list for review:` ,  numPaitingsArray);
  console.log("");
}
lotsOfArt(artists)
